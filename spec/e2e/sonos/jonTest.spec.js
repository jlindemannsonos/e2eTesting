...
module.exports = {
	...
	start: function(drive, browser, forceRun) {
		...
		describe('Sonos Home Page', function() {
			...
			it('System Page Text Check', function(done) {
				browser
					.elementByCssSelector('.section-title')
						.text()
						.should.eventually.contain('Play your favorite songs. Stream your favorite services.')
					.nodeify(done);
			});
